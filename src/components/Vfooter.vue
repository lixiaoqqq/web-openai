...
footer.page-footer#footer(v-once)
        ...
        ul.list
          li
            a(href="http://www.qiniu.com/" target="_blank" rel="nofollow")
              img(height="24" style="margin-left: -6px;" src='//imgslim.geekpark.net/image/newgeekpark/qiniu_1.png')
          li
          ...
          li
            a(href="http://www.bokecc.com/" target="_blank" rel="nofollow")
              img(height="25" src='//imgslim.geekpark.net/image/newgeekpark/huode_scene_3.png').huode_scene
  ...
  .footer-copyright
    .container
      .info-icp
        a(href="https://beian.miit.gov.cn/" target="_blank" rel="nofollow") 京ICP备13016923号-2
        | &nbsp;&nbsp;|&nbsp;&nbsp;
